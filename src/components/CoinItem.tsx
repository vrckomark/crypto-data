...
export default function CoinItem({ data }: any) {
  return (
    <div
      className="text-slate-300 grid grid-cols-2 grid-rows-2 text-lg bg-gray-800 rounded-xl mx-4 mb-10 pb-4 items-center sm:text-xl lg:grid-cols-5 lg:grid-rows-1 lg:pb-4 lg:pt-4 gap-4 lg:mx-6
    "
    >
